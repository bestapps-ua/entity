...
declare namespace BestApps {
    namespace interfaces {
        ...
        interface ICacheFactoryModel extends _ICacheFactoryModel {
        }
        interface ICacheFactoryModelOptions extends _ICacheFactoryModelOptions {
        }
        interface ICacheModel extends _ICacheModel {
        }
        interface ICacheModelOptions extends _ICacheModelOptions {
        }
        interface ICacheOptions extends _ICacheOptions {
        }
        interface ICacheRedisModelOptions extends _ICacheRedisModelOptions {
        }
        interface IConfigCache extends _IConfigCache {
        }
        interface IEntityItemsFilter extends _IEntityItemsFilter {
        }
        interface IEntityItemsCountParams extends _IEntityItemsCountParams {
        }
        interface IEntityItemsJoin extends _IEntityItemsJoin {
        }
        interface IEntityItemsParams extends _IEntityItemsParams {
        }
        interface IEntityItemsSort extends _IEntityItemsSort {
        }
        interface IEntityItemsWhere extends _IEntityItemsWhere {
        }
        interface IEntitySQLMakeResponse extends _IEntitySQLMakeResponse {
        }
        interface IEntitySQLMakeErrorResponse extends _IEntitySQLMakeErrorResponse {
        }
        interface IEntitySQLMakeListResponse extends _IEntitySQLMakeListResponse {
        }
        interface IEntitySQLMakeScheme extends _IEntitySQLMakeScheme {
        }
        interface IEntitySQLModel extends _IEntitySQLModel {
        }
        interface IEntitySQLModelOptions extends _IEntitySQLModelOptions {
        }
        interface IEntityModelOptions extends _IEntityModelOptions {
        }
